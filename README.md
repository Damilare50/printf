...
## Description
This team project is part of the Foundations curriculum of ALX School.
...
* All files were compiled with the command ```gcc -Wall -Werror -Wextra -std=gnu89 *.c```
...
### Authors
* **Daniel Momodu** - [danielMMomodu@gmail.com](https://github.com/The-Astronautt)
* **Oluwadamilare Okubanjo** - [damilarelamine@gmail.com](https://github.com/Damilare50)
